...
var $author$project$Main$init = $author$project$Main$Clear;
...
var $author$project$Main$Select = $elm$core$Basics$identity;
var $author$project$Main$clickMsg = F4(
	function (boxId, rowId, itemId, s) {
		if (!s.$) {
			switch (s.a) {
				case 1:
					return A3($author$project$Main$Item, boxId, rowId, itemId);
				case 2:
					return A2($author$project$Main$Row, boxId, rowId);
				case 3:
					return $author$project$Main$Box(boxId);
				default:
...
var $author$project$Main$onMultiClick = function (intToMsg) {
	return A2(
...
var $author$project$Main$item = F4(
	function (selection, boxId, rowId, itemId) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$author$project$Main$onMultiClick(
					A3($author$project$Main$clickMsg, boxId, rowId, itemId)),
					...
					_List_fromArray(
						[
							...
							_Utils_eq(
								selection,
								A3($author$project$Main$Item, boxId, rowId, itemId)))
						]))
				]),
			_List_Nil);
	});
var $author$project$Main$row = F3(
	function (selection, boxId, rowId) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							...
							_Utils_eq(
								selection,
								A2($author$project$Main$Row, boxId, rowId)))
						]))
				]),
			A2(
				$elm$core$List$map,
				A3($author$project$Main$item, selection, boxId, rowId),
				A2($elm$core$List$range, 1, 3)));
	});
var $author$project$Main$box = F2(
	function (selection, boxId) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							_Utils_Tuple2('box', true),
							_Utils_Tuple2(
							'selected',
							_Utils_eq(
								selection,
								$author$project$Main$Box(boxId)))
						]))
				]),
			A2(
				$elm$core$List$map,
				A2($author$project$Main$row, selection, boxId),
				A2($elm$core$List$range, 1, 3)));
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						_Utils_Tuple2('main', true),
						_Utils_Tuple2(
						'selected',
						_Utils_eq(model, $author$project$Main$All))
					]))
			]),
		A2(
			$elm$core$List$map,
			$author$project$Main$box(model),
			A2($elm$core$List$range, 1, 3)));
};
